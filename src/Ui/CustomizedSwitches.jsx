...
const Android12Switch = styled(Switch)(({ theme }) => ({
  ...
  '& .MuiSwitch-track': {
    ...
    '&::before': {
      backgroundImage: `url("data:image/svg+xml;utf8,${encodeURIComponent(
        '<svg xmlns="http://www.w3.org/2000/svg" height="16" width="16" viewBox="0 0 24 24"><path fill=\'white\' d="M21,7L9,19L3.5,13.5L4.91,12.09L9,16.17L19.59,5.59L21,7Z"/></svg>'
      )}")`,
      left: 12,
    },
    '&::after': {
      backgroundImage: `url("data:image/svg+xml;utf8,${encodeURIComponent(
        '<svg xmlns="http://www.w3.org/2000/svg" height="16" width="16" viewBox="0 0 24 24"><path fill=\'white\' d="M19,13H5V11H19V13Z"/></svg>'
      )}")`,
      right: 12,
    },
  },
...
export default function CustomizedSwitches() {
  return (
    <FormGroup>
      <FormControlLabel
        control={<MaterialUISwitch sx={{ m: 1 }} defaultChecked inputProps={{ 'aria-label': 'MUI switch' }} />}
        label=""
      />
